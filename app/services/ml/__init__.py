...
class MlService(AbstractMlService):
    ...
    def get_trend(self) -> list[str]:
        ...
        trends = [titles[i] for i in index_best_news]
        return trends
